...
$.extend(ns.Brick.prototype, wall.Brick.prototype, {
    ...
    initPlayer: function(elem, post) {
        $("#youtube-player-container").tubeplayer({
            ...
            height: $(window).height() - 5, // the height of the player
    ...
    initPost: function(elem, post) {
        $("<div id='youtube-player-container' scrolling='no' margin='0 auto'>").appendTo(elem);
        if(!$.fn.tubeplayer){
        ...
        this.ui.call("youtube.search", {"query": $("#url-query").val()},
                $.proxy(function(results) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        $("<p>").text(result.videoid).appendTo(li);
                    }
                }, this));
    },
